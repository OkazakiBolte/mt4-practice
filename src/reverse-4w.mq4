...
#define MAGIC_NUMBER 0xAAAB

/* ==== Inputs ==== */
input int window_open  = 20;
input int window_close = 5;
input double MaximumRisk = 0.02;
input double DecreaseFactor = 0.20;
input double IncreaseFactor = 0.10;
...
double LotsOptimized(){
    ...
    if (DecreaseFactor>0){
        ...
        if (profits > 1){
            lot_size = NormalizeDouble(lot_size + lot_size*losses*IncreaseFactor, 2);
        }
    }
